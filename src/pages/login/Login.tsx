    ...
    <div>
      <Container>
        <div className="bg-slate-300 p-12 rounded flex flex-col justify-center items-center [&>*]:my-2">
            <input type="text" placeholder="username" name="username" onChange={handleOnChange} value={user.username}/><input type="text" placeholder="password" name="password" onChange={handleOnChange} value={user.password}/>
